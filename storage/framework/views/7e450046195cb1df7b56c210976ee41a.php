...
[$__name, $__params] = $__split('multi-step-form', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1271091782-0', $__slots ?? [], get_defined_vars());
        ...
        <div class="row align-items-center">
          <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-10">
            <div class="hero-content">
							<h1>Launch Your New SaaS Website in Minutes!</h1>
				...
				<div class="row justify-content-center">
					<div class="col-xxl-6 col-xl-7 col-lg-8 col-md-11">
						<div class="section-title text-center mb-60">
							<h2>Modern design <br class="d-block"> with Essential Features</h2>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-6 col-md-10">
						<div class="feature-content-wrapper">
							<div class="section-title">
								...
								<a href="#0" class="main-btn btn-hover border-btn">Read More</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6 col-md-10">
						<div class="feature-content-wrapper">
							<div class="section-title">
								<h2 class="mb-30">Quick & Easy to <br class="d-none d-sm-block"> Use Bootstrap Template</h2>
								<p class="mb-30">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed dinonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem.Lorem ipsum dolor sit amet.</p>
								<a href="#0" class="main-btn btn-hover border-btn">Read More</a>
							</div>
						</div>
				...
				<div class="row justify-content-center">
					<div class="col-lg-6">
						<div class="section-title text-center mb-40">
							<h2>What our <br class="d-block"> customers says</h2>
						</div>
					</div>
				</div>
				<div class="row justify-content-center">
							...
							<div class="testimonial-active">
								<div class="single-testimonial">
									<div class="testimonial-content">
										...
										<div class="content">
											<p>Lorem ipsum dolor sit amet, coetur sadipscing sed diam nonumy eirmod tempor invidunt ut labore dolore magna aliquyam.</p>
										</div>
										<div class="info">
											<h5>Muhammad Hafiz</h5>
											<p>Founder, Abc It Agency</p>
										</div>
									</div>
								</div>
								<div class="single-testimonial">
				...
				<div class="row justify-content-center">
					<div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10">
						<div class="section-title text-center">
							<h2>Chose Our <br class="d-block"> Best Pricing Plan</h2>
				...
				<div class="row align-items-center justify-content-center">
					<div class="col-lg-4 col-md-8 col-sm-10">
						<div class="single-pricing basic">
							<div class="pricing-header">
								<h5 class="package-name">Startup Business</h5>
								<h3>Monthly Support</h3>
							</div>
							<div class="pricing-body">
								<ul>
									<li>
										<i class="lni lni-checkmark-circle active"></i>
										<p>Awesome Support</p>
									</li>
									<li>
										<i class="lni lni-checkmark-circle active"></i>
							...
							<div class="pricing-footer">
								<a href="#0" class="main-btn btn-hover border-btn">Purchase Now</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-8 col-sm-10">
						<div class="single-pricing standard">
							<div class="pricing-header">
								<h5 class="package-name">Standard Business</h5>
					...
					<div class="col-lg-4 col-md-8 col-sm-10">
						<div class="single-pricing premium">
							<div class="pricing-header">
								<h5 class="package-name">Pro Business</h5>
			...
			<div class="container">
				...
				<div class="row justify-content-center">
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-10">
						<div class="single-team">
							<div class="team-image">
								<img src="<?php echo e(asset('assets/images/team/team-1.jpg')); ?>" alt="">
							</div>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-10">
						<div class="single-team">
							<div class="team-image">
								<img src="<?php echo e(asset('assets/images/team/team-2.jpg')); ?>" alt="">
							</div>
							<div class="team-content">
								<div class="social">
									<ul>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-10">
						<div class="single-team">
							<div class="team-image">
								<img src="<?php echo e(asset('assets/images/team/team-3.jpg')); ?>" alt="">
							</div>
							<div class="team-content">
								<div class="social">
									<ul>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-10">
						<div class="single-team">
							<div class="team-image">
								<img src="<?php echo e(asset('assets/images/team/team-4.jpg')); ?>" alt="">
							</div>
							<div class="team-content">
								<div class="social">
									<ul>
...
<?php echo $__env->make('layouts.home.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/arajeeznet/wakeel.arajeez.net/wakeel/resources/views/home.blade.php ENDPATH**/ ?>