<li class="nav-item"> <img src="{{ asset('storage/' . Auth::user()->avatar) }}" alt="profile_picture"
    ...
    <!-- Settings Button -->
    <a href="{{ route('profile.settings.update') }}" class="dropdown-item">
        <i class="fas fa-cog fa-sm c-main mr-2"></i>{{ __('Settings') }}
    </a>
